========================================================================
    コンソール アプリケーション: TestBoostCoroutine プロジェクトの概要
========================================================================

この TestBoostCoroutine アプリケーションは、AppWizard により作成されました。

このファイルには、TestBoostCoroutine 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


TestBoostCoroutine.vcxproj
...
TestBoostCoroutine.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、TestBoostCoroutine.pch 
